...
def main(args):
    ...
    train_dir = os.path.join(args.data_path, args.train_path)
...
def get_args_parser(add_help=True):
    ...
    parser.add_argument("--ckpt-path", type=str, help="model checkpointpath")

    parser.add_argument("--train-path", default="train_1p_random", type=str, help="train path")
